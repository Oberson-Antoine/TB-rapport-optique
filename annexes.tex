...
\begin{figure}[H]
    \centering
    \includepdf[pages=-,scale=0.7,angle = 90,pagecommand={}]{assets/Annexes/assemblage_spray.pdf}
    %\includegraphics[width = \textwidth]{assets/Annexes/chablon trous.pdf}
\end{figure}
...
\lstinputlisting[style=Matlab-editor,numbers=left]{assets/code/mesures_automatiques_4_0_exported.m}
\footnotetext{Télécharger fichiers source \href{https://1drv.ms/f/s!Altwa7Vt0GlIj58Nf_KP9MAyebNbUA?e=5ZQHAe}{ici}}
...
\lstinputlisting[style=Matlab-editor,numbers=left]{assets/code/fried.m}
\footnotetext{Télécharger fichiers source \href{https://1drv.ms/f/s!Altwa7Vt0GlIjqIo0fPcbU9wN-YUhg?e=IFhokF}{ici}}
