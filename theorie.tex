...
Pour illuster concrêtement les effets les effets des turbulences, ainsi que donner une idée de l'impact de la valeur du seeing sur la PSF\footnotemark (Point Spead Function) d'un téléscope
:
\begin{figure}[H]
  \centering
  \includegraphics[width=0.5\textwidth]{assets/figures/théorie/PSF_parfaite.png}
  \caption[PSF parfaite]{PSF parfaite d’un télescope de 1m de diamètre, longueur d'onde 500 nm}
\end{figure}
...
\end{figure}
\footnotetext{La PSF décrit la distribution d’intensité de la lumière provenant d’un point source.}
\begin{figure}[H]
  \centering
...
\say{Un capteur de Shack-Hartmann consiste en une grille de lentilles et une caméra. Quand un front d'onde entre dans la matrice de lentilles,
  un champs de point est créé sur la caméra. L'intensité et la position de chaque point est analysé pour mesurer dynamiquement le front d'onde
  de sources laser ou de caractériser la distortion de front d'onde causée par des composants optiques.}\footnotemark[5]
